...
class VNA(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "SDR VNA", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("SDR VNA")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "VNA")
        ...
        self.dev_addr_rx = dev_addr_rx = "serial=3233C8E"
        self.center_freq = center_freq = 1.1e9
        ...
        self.qtgui_eye_sink_x_0_0.set_samp_per_symbol(int(sps))
        ...
        self.digital_symbol_sync_xx_0 = digital.symbol_sync_cc(
            ...
            128,
            [])
        self.digital_costas_loop_cc_0 = digital.costas_loop_cc(0.03, 4, False)
        ...
        self.connect((self.analog_agc_xx_0, 0), (self.qtgui_eye_sink_x_0_0, 0))
    ...
    def set_sps(self, sps):
        ...
        self.qtgui_eye_sink_x_0_0.set_samp_per_symbol(int(self.sps))

    def get_dev_addr_rx(self):
        return self.dev_addr_rx

    def set_dev_addr_rx(self, dev_addr_rx):
        self.dev_addr_rx = dev_addr_rx
...
def main(top_block_cls=VNA, options=None):
