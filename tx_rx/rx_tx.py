...
class rx_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "rx_tx")
        ...
        self.qtgui_time_sink_x_1.set_trigger_mode(qtgui.TRIG_MODE_NORM, qtgui.TRIG_SLOPE_POS, 0.0, 0, 0, access_code)
        ...
        self.epy_block_0 = epy_block_0.packet_framer()
        ...
        self.digital_correlate_access_code_xx_ts_0 = digital.correlate_access_code_bb_ts("00011101000011110011111010011010",
          0, '')
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\hp\\Desktop\\RF\\img processing\\recv_data.bin', False)
        ...
        self.connect((self.digital_correlate_access_code_xx_ts_0, 0), (self.blocks_pack_k_bits_bb_1, 0))
        ...
        self.connect((self.digital_symbol_sync_xx_0, 2), (self.blocks_null_sink_1, 0))
        self.connect((self.digital_symbol_sync_xx_0, 3), (self.blocks_null_sink_2, 0))
    ...
    def set_access_code(self, access_code):
        ...
        self.qtgui_time_sink_x_1.set_trigger_mode(qtgui.TRIG_MODE_NORM, qtgui.TRIG_SLOPE_POS, 0.0, 0, 0, self.access_code)
